...
lwl.bk.dbkeys.bot=data.frame(depth="bottom",
                         SITE=c(rep("LWL19",2),rep("LWL20A",2)),
                         param=rep(c("WT","SPC"),2),
                         DBKEY=c("39343","39347","39450","39452")
)
...
```{r EAA_stg, echo=FALSE,fig.width=7,fig.height=6,fig.align='center',fig.cap="EAA canal stage relative to 'optimum' stage levels as identified in LORS2008."}
