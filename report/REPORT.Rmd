...
wnd.dat2=DBHYDRO_daily(dates[1],dates[2],dbkeys.bk$DBKEY,vert_datum = NA)
...
windrose_plot(wind_dat,"fivenum","oceanographic",max.val=roundUp(max(wind_dat$fives,na.rm=T)),lab.col="black",xpd=NA)
