...
```{r SLE_LOK_Q, echo=FALSE,fig.width=6,fig.height=4,fig.align='center',fig.cap="S-308 (from Lake Okeechobee) and S-80 (to Lower Fork) flow data along the C-44 and St Lucie River. C-44 Basin Flow was calculated as the difference from S-308 and S-80."}
