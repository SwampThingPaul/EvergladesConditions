...
cols.df=data.frame(expand.grid(mon=1:12,CY=2012:2024))
...
cols.df[cols.df$monCY.date%in%seq(date.fun("2020-09-01"),date.fun("2024-12-01"),"months"),"col"]=cols.val[6]
...
cols.df[cols.df$monCY.date%in%seq(date.fun("2020-09-01"),date.fun("2024-12-01"),"months"),"ops"]=cols.labs[6]
...
```{r}
data.frame(LEGEND=c("IOP","ERTP","Increment 1","2016 Emergency Deviation","Increment 1.1/1.2","2017 Temporary Deviation","Increment 2","COP"))|>
  flextable()|>
  bold()|>
  bold(part="header")|>
  align(part="all",align="center")|>
  padding(padding=2,part="all")|>
  bg(bg=c("cornsilk","lightgreen","lightblue","lightblue","dodgerblue1","dodgerblue1","steelblue","pink"))|>
  color(color=c(rep("black",3),"maroon","black","hotpink","yellow","black"))|>
  autofit()
```
